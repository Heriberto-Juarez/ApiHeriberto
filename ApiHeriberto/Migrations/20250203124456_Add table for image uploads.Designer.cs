...
namespace ApiHeriberto.Migrations
{
    ...
    [Migration("20250203124456_Add table for image uploads")]
    partial class Addtableforimageuploads
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiHeriberto.Models.Domain.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApiHeriberto.Models.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApiHeriberto.Models.Domain.Walk", b =>
                {
                    b.HasOne("ApiHeriberto.Models.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiHeriberto.Models.Domain.Region", "Region")
                        .WithMany()
